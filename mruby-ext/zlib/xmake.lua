...
function common_settings()
    ...
    -- ./configure, which the inline xmake build skips). Without it, Clang's
    -- C99 strict mode on macOS errors on the implicit declarations. Windows
    -- uses <io.h> instead, so only define this off-Windows.
